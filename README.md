----
This is basic overview of the whole Smail project.
It consists of:
- Landing (/landing folder)
- Backend (/gcp_backend folder)
- Application (root folder)

## The Development Process
0. Ensure you have an access to github (https://github.com/adampackets/Ed) and trello board (https://trello.com/b/0defDRVo/mail-app)
1. Move the Trello card to Doing
2. Create a local branch for the feature
3. Get job done (please commit and push the changes as soon as you make them, don't wait until the whole work is finished)
4. Check your changes one more time. If you want, ask somebody to review them
...
- App listing on Play Store [link](https://play.google.com/store/apps/details?id=com.smail.app.android&ah=CXtH2thjg3Dl_KgaPLLmIANUq-0). Not that you might not see it yet as it is under private alpha. If you want, just ask to be added to the list of testers.
