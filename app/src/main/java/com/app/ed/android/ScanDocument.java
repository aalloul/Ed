...
public class ScanDocument extends Fragment
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            scanDocumentInterface.cameraApiIncompatibility(getResources().getString(R.string.camera_error));
        }
    }

    /**
     * Opens the camera specified by {@link ScanDocument#mCameraId}.
     */
    private void openCamera(int width, int height) {

        if (!scanDocumentInterface.hasCameraPermission()) {
            return;
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.scan_document_take_picture: {
                takePicture();
                break;
            }
